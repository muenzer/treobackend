...
module.exports.createRegistrationMail = function(object) {
	...
	var data = {	
			...
			Class:object.ClassName,
			Date:dateFormat(object.Date, "mmmm dS"),
			Status:object.PaymentStatus,
			Cost:object.Cost,
			"Payment Due":object.Payment,
			"Due Date": dateFormat(object.DueDate, "mmmm dS")
		};
	...
	var input = { 
          ...
          subject: "New Registration: " + object.ClassName + " - " + dateFormat(object.Date, "mmmm dS"),
          html: html
        }; 
